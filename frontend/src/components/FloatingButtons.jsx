    ...
    <>
      ...
      <div className="mobile-bottom">
        <div className="mobile-bottom__row wrap">
          <a href="tel:+919221105658" className="btn btn--outline"><FaPhoneAlt /> Call</a>
          <a href="https://wa.me/919221105658?text=Hello%2C%20I%20want%20to%20enquire%20about%20admissions" target="_blank" rel="noopener noreferrer" className="btn btn--wa"><FaWhatsapp /> WhatsApp</a>
        </div>
      </div>
    </>
  );
