        ...
        <div className="founder-grid">
          <div className="founder-media">
            <div className="founder-img-container">
              <div className="founder-img-wrapper">
                <img src="/Prof Satish Maurya Final.png" alt="Prof. Satish Maurya - Founder, SS Coaching Classes" className="founder-img" loading="lazy" />
              </div>
          ...
          <div className="founder-content">
            ...
            <div className="founder-text">
              <p>
                Founded in 2008 by Mr. Satish Maurya and Mr. Sandeep Maurya, our institute was established with a clear vision—to bring a meaningful revolution to the field of education through quality teaching, academic excellence, and student-focused learning.
              </p>
              <p>
